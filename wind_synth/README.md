...
**Parameters:**
```
i1 start dur amp filterEnvTime ampEnvTime cutoff resonance pan lfoFreq lfoDepth
```
...
i1 0 5.0 0.4 2.5 4.0 800 1.0 0.5 0.2 0.4
```
...
**Parameters:**
```
i2 start dur amp attack release cutoff resonance pan
```
...
| p4 | Amplitude | Fixed volume level | 0.0-1.0 |
...
i2 0 6.0 0.5 0.5 0.8 400 0.8 0.2
```
...
**Gentle Breeze:**
```csound
i2 0 8.0 0.3 0.5 1.0 1200 0.6 0.5
```

**Dark Storm:**
```csound
i1 0 10.0 0.6 3.0 8.0 350 1.2 0.5 0.15 0.5
```

**Fluttering Wind:**
```csound
i1 0 5.0 0.4 1.5 4.0 1400 0.8 0.5 3.0 0.3
```

**Steady Drone (Background):**
```csound
i2 0 20.0 0.25 1.0 2.0 600 0.7 0.5
```

**Wind Gust:**
```csound
i1 0 1.5 0.7 0.5 1.2 1800 0.5 0.5 0 0
```
...
- `lfo` - Low frequency oscillator (Instrument 1)
- `limit` - Value clamping (Instrument 1)
...
i2 0 10.0 0.3 0.5 1.0 800 0.7 0.3   ; Background left
i2 0 10.0 0.3 0.5 1.0 1200 0.6 0.7  ; Background right
i1 2 5.0 0.4 2.0 4.0 1500 0.8 0.5 0.3 0.4  ; Foreground evolving
e
</CsScore>
```
...
csound_instruments/
├── wind_synth/
│   ├── wind_synth.csd   # Main Csound file (instruments + score)
│   ├── README.md        # This file
...
- Verify amplitude values (p4) are > 0
